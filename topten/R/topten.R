...
#'
#' This function develops a prediction algorithm based on the top 10 feastures in 'x' that are most predictive
#' of 'y'
#'
...
#'
#' @author Joseph L. Nguyen
#' @details
#' This function runs a univariate regression of y on each predictor in x and calculates a p-value indicating the significance of the association. The final set of 10 predictors is taken from the 10 smallest p-values.
#' @seealso \code{lm}
#' @export
#' @importFrom stats lm
